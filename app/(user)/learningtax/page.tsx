      ...
      <main className="px-8 py-4">
        ...
        <section>
          <div className="bg-pink-300 p-2 rounded-lg shadow-md transform transition duration-500 hover:scale-105 mb-6">
            ...
            <p className="text-gray-700">A certificate issued by an employer to its employees outlining the tax deducted at source (TDS) from the salary paid.</p>
          ...
          <div className="bg-lime-300 p-2 rounded-lg shadow-md transform transition duration-500 hover:scale-105 mb-6">
            ...
            <p className="text-gray-700">A consolidated tax statement that has all the details of tax deducted on behalf of the taxpayer (from salaries, interest income, etc.).</p>
            <a href="#" className="text-blue-500 hover:underline">Read More</a>
          </div>
          ...
          <div className="bg-indigo-300 p-2 rounded-lg shadow-md transform transition duration-500 hover:scale-105 mb-6">
            ...
            <p className="text-gray-700">There are multiple forms (ITR-1 through ITR-7) based on the nature and amount of income and the type of taxpayer (individual, company, etc.).</p>
            <a href="#" className="text-blue-500 hover:underline">Read More</a>
          </div>
          ...
          <div className="bg-cyan-300 p-2 rounded-lg shadow-md transform transition duration-500 hover:scale-105 mb-6">
            ...
            <p className="text-gray-700">These forms facilitate the reporting of various transactions, including sales, purchases, and tax payments, to the tax authorities. Includes GSTR-1 for outward supplies and GSTR-3B for a monthly summary.</p>
            <a href="#" className="text-blue-500 hover:underline">Read More</a>
          </div>
        </section>
        ...
        <section className="mt-12">
          ...
          <p className="mt-4">Keeping track of tax deadlines is crucial for compliance:</p>
