      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="bg-rose-400 p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105">
            <h3 className="text-xl font-semibold mb-2 text-gray-700">Step 1</h3>
          ...
          <div className="bg-rose-400 p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105">
            <h3 className="text-xl font-semibold mb-2 text-gray-700">Step 2</h3>
          ...
          <div className="bg-rose-400 p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105">
            <h3 className="text-xl font-semibold mb-2 text-gray-700">Step 3</h3>
        ...
        <section>
          <div className="bg-rose-600 p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105 mb-6">
          ...
          <div className="bg-rose-500 p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105 mb-6">
          ...
          <div className="bg-rose-400 p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105 mb-6">
          ...
          <div className="bg-rose-300 p-6 rounded-lg shadow-md transform transition duration-500 hover:scale-105 mb-6">
