...
//   return <div className="h-[200vh]">SHOP</div>
// }
      ...
      <nav className="flex flex-col gap-6 px-4 sm:max-lg:px-2">
        ...
        <div className="flex flex-col w-full h-screen justify-center items-center gap-y-10">
          <div className='flex flex-row gap-x-10'>
            <SideMenuInnerItem href="/learning"  modulename = "planning" icon="learn" label="Blogs/Articles " />
             <SideMenuInnerItem href="/learn"  modulename = "planning" icon="leaderboard" label="Gamified Learning" /> 
          </div>
          <div className='flex flex-row gap-x-10'>
            <SideMenuInnerItem href="/videos" modulename = "planning" icon="quests" label="Videos"/>
            <SideMenuInnerItem href="/shop" icon="shop"  modulename = "planning" label="Performance Tracker" />
          </div>
        </div>
      </nav>
      {/* <div className="space-y-5 border-t-7 px-2 pb-2 pt-2 sm:max-lg:px-2">
