    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="py-8">
        ...
        <ul className="list-none text-center">
          <li className="mb-2">
            <a href="https://www.mint.com/" className="text-blue-400 hover:text-blue-600 transition ease-in-out duration-300">
              Mint: Budget Tracker & Planner
            </a>
          </li>
          <li className="mb-2">
            <a href="https://www.nerdwallet.com/blog/finance/how-to-build-a-budget/" className="text-blue-400 hover:text-blue-600 transition ease-in-out duration-300">
              NerdWallet: How to Build a Budget
            </a>
          </li>
          <li className="mb-2">
            <a href="https://www.youneedabudget.com/method/" className="text-blue-400 hover:text-blue-600 transition ease-in-out duration-300">
              YNAB: Budgeting Method
            </a>
          </li>
          <li className="mb-2">
            <a href="https://www.khanacademy.org/college-careers-more/personal-finance" className="text-blue-400 hover:text-blue-600 transition ease-in-out duration-300">
